...
#else
typedef void* esp_lcd_touch_handle_t; // stub when touch disabled
#endif
#include "lvgl.h"
...
#define CONFIG_EXAMPLE_LCD_TOUCH_CONTROLLER_GT911 0 // Use custom GT911 driver

// Fallback defaults for PlatformIO (no Kconfig)
#ifndef CONFIG_EXAMPLE_LVGL_PORT_TICK
#define CONFIG_EXAMPLE_LVGL_PORT_TICK 10
#endif
...
#define CONFIG_EXAMPLE_LVGL_PORT_TASK_PRIORITY 5
#endif
...
#define CONFIG_EXAMPLE_LVGL_PORT_BUF_HEIGHT 60
#endif
#ifndef CONFIG_EXAMPLE_LCD_RGB_BOUNCE_BUFFER_HEIGHT
#define CONFIG_EXAMPLE_LCD_RGB_BOUNCE_BUFFER_HEIGHT 10  // Use Arduino's anti-drift value
#endif
