...
#endif
#define LVGL_PORT_TICK_PERIOD_MS    (10)
...
#define LVGL_PORT_TASK_STACK_SIZE   (4 * 1024) // The stack size of the LVGL timer task, in bytes
...
#define LVGL_PORT_BUFFER_HEIGHT         (10)
